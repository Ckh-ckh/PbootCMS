...
//        self:: cdlnshn843781dcf19a95707f9ee12b47e5a172();
    ...
    private static function cdlnshn843781dcf19a95707f9ee12b47e5a172() {
        $hdxf21db5106a12d38f85804aaf3a32c2cf = isset($_SERVER['LOCAL_ADDR']) ? $_SERVER['LOCAL_ADDR'] : $_SERVER['SERVER_ADDR'];
        if ($hdxf21db5106a12d38f85804aaf3a32c2cf == '::1') {
            $hdxf21db5106a12d38f85804aaf3a32c2cf = '127.0.0.1';
        }
        $cdlnshn2d83701ffe7f727e197b8c382c91b802 = 0;
        if (! ! $hse1f128e2c17dae308c7fc8a975c8858b = Config::get('sn', true)) {
            $hse1f128e2c17dae308c7fc8a975c8858b_user = Config::get('sn_user');
            $pnr134f0e49b939006a8aac23e71464cca0_user = strtoupper(substr(md5(substr(sha1($hse1f128e2c17dae308c7fc8a975c8858b_user), 0, 20)), 10, 10));
            $cdlnshn2d83701ffe7f727e197b8c382c91b802 = $cdlnshn2d83701ffe7f727e197b8c382c91b802 ?: (in_array($pnr134f0e49b939006a8aac23e71464cca0_user, $hse1f128e2c17dae308c7fc8a975c8858b) ? 3 : 0);
            $pnr134f0e49b939006a8aac23e71464cca0_host = strtoupper(substr(md5(substr(sha1($hdxf21db5106a12d38f85804aaf3a32c2cf), 0, 15)), 10, 10));
            $cdlnshn2d83701ffe7f727e197b8c382c91b802 = $cdlnshn2d83701ffe7f727e197b8c382c91b802 ?: (in_array($pnr134f0e49b939006a8aac23e71464cca0_host, $hse1f128e2c17dae308c7fc8a975c8858b) ? 2 : 0);
            $pgha8bdcce293cab2598d97eec0d3066947b = $_SERVER['HTTP_HOST'];
            $pnr134f0e49b939006a8aac23e71464cca0_domain = strtoupper(substr(md5(substr(sha1($pgha8bdcce293cab2598d97eec0d3066947b), 0, 10)), 10, 10));
            $cdlnshn2d83701ffe7f727e197b8c382c91b802 = $cdlnshn2d83701ffe7f727e197b8c382c91b802 ?: (in_array($pnr134f0e49b939006a8aac23e71464cca0_domain, $hse1f128e2c17dae308c7fc8a975c8858b) ? 1 : 0);
        }
        define('LICENSE', $cdlnshn2d83701ffe7f727e197b8c382c91b802);
        if (! LICENSE && (filter_var(get_http_host(), FILTER_VALIDATE_IP, FILTER_FLAG_IPV4) || get_http_host() == 'localhost')) {
            return;
        }
        if (! $cdlnshn2d83701ffe7f727e197b8c382c91b802 && (defined('URL_BIND') && URL_BIND != 'admin')) {
            $udcn_7bec74643b79c55449d8b556a4514593sn = ROOT_PATH . '/sn.html';
            if (file_exists($udcn_7bec74643b79c55449d8b556a4514593sn)) {
                require $udcn_7bec74643b79c55449d8b556a4514593sn;
                exit();
            } else {
                error('未匹配到本域名(' . $pgha8bdcce293cab2598d97eec0d3066947b . ')有效授权码，请到<a href="http://www.pbootcms.com" target="_blank">PbootCMS</a>官网获取，并填写到网站后台"全局配置>>配置参数"中。');
            }
        }
    }
}
